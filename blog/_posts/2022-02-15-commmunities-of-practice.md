...
{%marginnote 'reference' '_Dieser Text wurde erstmals veröffentlicht am 07. Dezember 2021 auf dem Blog des [ZLLF](https://www.hslu.ch/zllf){:target="_blank"} der [HSLU](https://www.hslu.ch){:target="_blank"}: <https://blog.hslu.ch/blog/archives/8028>{:target="_blank"}_'%}
