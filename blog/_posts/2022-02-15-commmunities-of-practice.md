...
Wie findet Lernen statt? Welche Faktoren fördern und unterstützen effektives Lernen?{%marginnote 'reference' '[Dieser Text wurde erstmals veröffentlicht am 07. Dezember 2021 auf dem Blog des Zentrums für Lernen, Lehren und Forschen der Hochschule Luzern](https://blog.hslu.ch/blog/archives/8028){:target="_blank"}_'%} Wie lassen sich Lernprozesse individualisierter gestalten und damit besser auf die Bedürfnisse aller Lerner:innen abstimmen? Dies sind nur einige der fundamentalen Fragen der Hochschuldidaktik. Dabei steht meist die einzelne Lerner:in im Zentrum der Aufmerksamkeit. Insbesondere die Lernpsychologie liefert durch ihre empirische Forschung zum Lernen differenzierte Antworten auf diese Fragen.
